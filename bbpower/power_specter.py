...
class BBPowerSpecter(PipelineStage):
    ...
    inputs = [('splits_list', TextFile),
              ...
              ('sims_list', TextFile),
              ('beams_list', TextFile)]
    outputs = [('cells_all_splits', FitsFile),
    ...
    def save_cell_to_file(self, cell: dict, tracers: list, fname: str, with_windows: bool = False) -> None:
        """
    ...
    def run(self) -> None:
        ...
        for isim, d in enumerate(sims):
            ...
            sim_splits = [f'{d}/obs_split{i+1}of{self.nsplits}.fits'
